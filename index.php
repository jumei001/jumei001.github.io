...
<body>
	...
	<div style="height:4%;width:100%;color:#fff;font-size:16px;margin:0 auto;background:#000;padding-top:6px;">
		...
		<span id="target" style="position:absolute;top:5%;right:10px;color:#fff;">更多吃呱群570301597<?php echo $row[7]; ?></span>
	...
	<div  style="position:absolute;bottom:260px;right:5px;">
		<a href="dh.bbbjjj3.cfd/jc" style=" text-decoration: none;"  target="_blank"><img src="./img/guanzhu.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<div  style="position:absolute;bottom:180px;right:5px;">
       <a href="dh.bbbjjj3.cfd/jc" style=" text-decoration: none;"  target="_blank"> <img src="./img/tongcheng.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<div  style="position:absolute;bottom:100px;right:5px;">
      <a href="dh.bbbjjj3.cfd/jc" style=" text-decoration: none;" target="_blank"> <img src="./img/dianzan.png" style="height:45px;width:45px;display: block;z-index: 21;">
	...
	<p style="text-align:center;">9.9元VIP免广告弹窗</p>
				<p style="text-align:center;">9.9元VIP观看完整高清视频</p>
				<p style="text-align:center;">9.9元VIP观看500部自录视频</p>
				<p style="text-align:center;">在线下单 送豪礼 尊享1v1服务</p></span>
	</p>
	</div> 
	<div class="board-btn-group">

	<a href="https://rk.bbbjjj3.cfd/index1.html" class="board-btn" style="background-color: rgb(252, 32, 103); color: rgb(255, 255, 255);text-decoration: none;">立即开通</a>
	</div>
	</div>
	</div>
	</div>
